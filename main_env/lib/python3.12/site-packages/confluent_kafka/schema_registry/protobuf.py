...
class ProtobufSerializer(object):
    ...
    |                                     |          | If the kafka_consumers of the topic being produced to are  |
    |                                     |          | using confluent-kafka-python <1.8 then this property |
    |                                     |          | must be set to True until all old kafka_consumers have     |
    |                                     |          | have been upgraded.                                  |
    |                                     |          |                                                      |
    ...
    def __init__(self, msg_type, schema_registry_client, conf=None):
        ...
        if conf is None or 'use.deprecated.format' not in conf:
            raise RuntimeError(
                ...
                "with older confluent-kafka-python Protobuf producers and kafka_consumers. "
        ...
        if self._use_deprecated_format:
            warnings.warn("ProtobufSerializer: the 'use.deprecated.format' "
                          ...
                          "kafka_consumers to 'use.deprecated.format':False as "
                          "soon as possible")
